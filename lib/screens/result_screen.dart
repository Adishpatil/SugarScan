              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(S.analyzing, style: const TextStyle(fontSize: 16)),
                      Text(S.running8passes, style: const TextStyle(color: Colors.grey)),
                    ],
                  ),
                )
              : _error != null
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text('${S.severity}: ${info.severity}',
                        ...
                        children: [
                          ...
                          LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation<Color>(
                              isTop ? color : Colors.grey.shade300),
                            minHeight: 8,
                          ),
                        ],
                      ),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(S.diseaseInfoTitle,
                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  const Divider(),
                  _InfoTile('📋 ${S.description}', info.description),
                  const SizedBox(height: 8),
                  _InfoTile('🦠 ${S.cause}', info.cause),
                  const SizedBox(height: 8),
                  _InfoTile('💊 ${S.treatment}', info.treatment),
                ],
              ),
            ),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(_saved ? S.saved : S.saveHistory),
